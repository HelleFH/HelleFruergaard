const projects = [
    {
      ...
      images: [`my-portfolio/images/ecommerce-screen.png`],
    ...
    },
    {
      ...
      images: [`my-portfolio/images/calendar-screen.png`],
    ...
    },
    {
      ...
      name: "MERN Listings",
      technologies: "MongoDB, Express, React, Node.js",
      images: [`my-portfolio/images/listing-screen.png`],
    ...
    },
    {
      ...
      images: [`my-portfolio/images/aiimages-screen.png`],
    ...
    },
    {
      ...
      images: [`my-portfolio/images/phpcart-screen.png`],
    ...
    },
    {
      ...
      images: [`my-portfolio/images/datingapp-screen.png`],
    ...
    },
    {
      ...
      images: [`my-portfolio/images/netflix-screen.png`],
    ...
    },
    {
      ...
      name: "MEVN Cart",
      technologies: "MongoDB, Express, Vue, Node.js",
      images: [`my-portfolio/images/mevncart-screen.png`],
    ...
    },
    {
      ...
      technologies: "JQuery",
      images: [`my-portfolio/images/dinosaurs-screen.png`],
    ...
    },
    {
      ...
      images: [`my-portfolio/images/legekrogen-screen.png`],

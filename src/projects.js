const projects = [
    {
      ...
      images: [`${process.env.PUBLIC_URL}/images/ecommerce-screen.png`],
      ...
      login: "User: duser7707@gmail.com  - Demopassword123",
      adminLogin: "Admin: dmndmuser@gmail.com -Demopassword123"
    },
    {
      id: 2,
      name: "MERN Plant Calendar",
      technologies: "MongoDB, Express, React, Node.js",
      images: [`${process.env.PUBLIC_URL}/images/calendar-screen.png`],
      ...
      description: "App made to track and manage plants. Users can add plants either manually or by searching a database using an external API. The calendar has a reminder function and users can add updates to exsisting plants to track progress over time.",
      login: "Username Hellefruergaard@plantcalendar.com - Password:fruergaard"
    },
    {
      id: 3,
      name: "MERN Listings",
      technologies: "MongoDB, Express, React, Node.js",
      images: [`${process.env.PUBLIC_URL}/images/listing-screen.png`],
      projectLink: "https://react-listings-frontend.onrender.com/",
    ...
    },
    {
      ...
      images: [`${process.env.PUBLIC_URL}/images/aiimages-screen.png`],
    ...
    },
    {
      ...
      images: [`${process.env.PUBLIC_URL}/images/phpcart-screen.png`],
    ...
    },
    {
      ...
      images: [`${process.env.PUBLIC_URL}/images/datingapp-screen.png`],
    ...
    },
    {
      ...
      images: [`${process.env.PUBLIC_URL}/images/netflix-screen.png`],
    ...
    },
    {
      ...
      name: "MEVN Cart",
      technologies: "MongoDB, Express, Vue, Node.js",
      images: [`${process.env.PUBLIC_URL}/images/mevncart-screen.png`],
      projectLink: "https://shopping-cart-master-fe.onrender.com",
      ...
      login: "Username: hellefruergaard@mevn-shop.com, Password:password123"
    },
    {
      id: 9,
      name: "Lightbox Gallery",
      technologies: "JQuery",
      images: [`${process.env.PUBLIC_URL}/images/dinosaurs-screen.png`],
    ...
    },
    {
      ...
      images: [`${process.env.PUBLIC_URL}/images/legekrogen-screen.png`],
